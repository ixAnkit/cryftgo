...
// Source: github.com/MetalBlockchain/metalgo/x/sync (interfaces: Client)
//
// Generated by this command:
//
//	mockgen -package=sync -destination=x/sync/mock_client.go github.com/MetalBlockchain/metalgo/x/sync Client
//
