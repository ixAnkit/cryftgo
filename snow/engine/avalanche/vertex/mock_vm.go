...
//
//	mockgen -package=vertex -destination=snow/engine/avalanche/vertex/mock_vm.go github.com/MetalBlockchain/metalgo/snow/engine/avalanche/vertex LinearizableVM
//
