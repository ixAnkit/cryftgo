...
// Source: github.com/MetalBlockchain/metalgo/message (interfaces: OutboundMessage)
//
// Generated by this command:
//
//	mockgen -package=message -destination=message/mock_message.go github.com/MetalBlockchain/metalgo/message OutboundMessage
//
